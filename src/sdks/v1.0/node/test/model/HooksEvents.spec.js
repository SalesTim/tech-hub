...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SalesTimApi.HooksEvents();
  });
  ...
  describe('HooksEvents', function() {
    it('should create an instance of HooksEvents', function() {
      // uncomment below and update the code to test HooksEvents
      //var instane = new SalesTimApi.HooksEvents();
      //expect(instance).to.be.a(SalesTimApi.HooksEvents);
    });
    ...
    it('should have the property odataContext (base name: "@odata.context")', function() {
      ...
      //var instance = new SalesTimApi.HooksEvents();
