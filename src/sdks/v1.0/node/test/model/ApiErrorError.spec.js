...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SalesTimApi.ApiErrorError();
  });
  ...
  describe('ApiErrorError', function() {
    it('should create an instance of ApiErrorError', function() {
      ...
      //var instane = new SalesTimApi.ApiErrorError();
      //expect(instance).to.be.a(SalesTimApi.ApiErrorError);
    });

    it('should have the property code (base name: "code")', function() {
      // uncomment below and update the code to test the property code
      //var instance = new SalesTimApi.ApiErrorError();
