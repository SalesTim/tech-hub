...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SalesTimApi.TeamChannelTabTeamsApp();
  });
  ...
  describe('TeamChannelTabTeamsApp', function() {
    it('should create an instance of TeamChannelTabTeamsApp', function() {
      ...
      //var instane = new SalesTimApi.TeamChannelTabTeamsApp();
      //expect(instance).to.be.a(SalesTimApi.TeamChannelTabTeamsApp);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new SalesTimApi.TeamChannelTabTeamsApp();
