...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SalesTimApi.AuditTrails();
  });
  ...
  describe('AuditTrails', function() {
    it('should create an instance of AuditTrails', function() {
      // uncomment below and update the code to test AuditTrails
      //var instane = new SalesTimApi.AuditTrails();
      //expect(instance).to.be.a(SalesTimApi.AuditTrails);
    });
    ...
    it('should have the property odataContext (base name: "@odata.context")', function() {
      ...
      //var instance = new SalesTimApi.AuditTrails();
