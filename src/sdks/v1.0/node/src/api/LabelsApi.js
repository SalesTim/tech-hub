...
export default class LabelsApi {
    ...
    */
     ...
     * @callback module:api/LabelsApi~getMyLabelsCallback
     ...
     * @param {module:api/LabelsApi~getMyLabelsCallback} callback The callback function, accepting three arguments: error, data, response
