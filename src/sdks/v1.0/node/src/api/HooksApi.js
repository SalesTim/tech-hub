...
export default class HooksApi {
    ...
    */
     ...
     * @callback module:api/HooksApi~generateHookSignatureCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/HooksApi~generateHookSignatureCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:api/HooksApi~getHooksEventsCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/HooksApi~getHooksEventsCallback} callback The callback function, accepting three arguments: error, data, response
