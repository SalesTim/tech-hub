...
function Initialize-Labels {
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => Labels' | Write-Debug
...
Convert from JSON to Labels<PSCustomObject>
...
Labels<PSCustomObject>
#>
function ConvertFrom-JsonToLabels {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => Labels' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Labels
