            ...
            <div class="uk-card uk-card-hover uk-card-default uk-padding-small">
              ...
              <div class="uk-card-footer uk-padding-small">
                <p class="uk-text-small">
                  <i>Published by <a class="author-link" :href="post.frontmatter.author.profile" target="_blank">{{ post.frontmatter.author.name }}</a></i>
                  &nbsp;{{ post.dateFromNow }}, tagged as&nbsp;<span v-for="tag in post.frontmatter.tags" style="margin-right: 5px;">
  ...
  computed: {
    posts () {
      ...
      posts.forEach((post,i) => {
        posts[i].dateFromNow = moment(post.frontmatter.date, "YYYYMMDD").fromNow()
