...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SalesTimApi.HookSignature();
  });
  ...
  describe('HookSignature', function() {
    it('should create an instance of HookSignature', function() {
      // uncomment below and update the code to test HookSignature
      //var instane = new SalesTimApi.HookSignature();
      //expect(instance).to.be.a(SalesTimApi.HookSignature);
    });
    ...
    it('should have the property odataContext (base name: "@odata.context")', function() {
      ...
      //var instance = new SalesTimApi.HookSignature();
