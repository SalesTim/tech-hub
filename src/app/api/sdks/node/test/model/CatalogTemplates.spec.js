...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SalesTimApi.CatalogTemplates();
  });
  ...
  describe('CatalogTemplates', function() {
    it('should create an instance of CatalogTemplates', function() {
      // uncomment below and update the code to test CatalogTemplates
      //var instane = new SalesTimApi.CatalogTemplates();
      //expect(instance).to.be.a(SalesTimApi.CatalogTemplates);
    });
    ...
    it('should have the property odataContext (base name: "@odata.context")', function() {
      ...
      //var instance = new SalesTimApi.CatalogTemplates();
